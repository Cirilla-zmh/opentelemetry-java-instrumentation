...
import io.opentelemetry.instrumentation.api.instrumenter.genai.tool.ArmsGenAiToolAttributesExtractor;
  ...
  public SpringAiTelemetry build() {
    ...
    Instrumenter<ChatClientRequest, ChatClientResponse> chatClientInstrumenter =
        Instrumenter.<ChatClientRequest, ChatClientResponse>builder(
            ...
            .addAttributesExtractor(ArmsGenAiAttributesExtractor.create(ChatClientAttributesGetter.INSTANCE))
            ...
            .addAttributesExtractor(new ArmsCommonAttributeExtractor(ArmsRpcTypeEnum.LOCAL_CALL.getCode(),
    ...
    Instrumenter<ToolCallRequest, String> toolCallInstrumenter =
        Instrumenter.<ToolCallRequest, String>builder(
            ...
            .addAttributesExtractor(ArmsGenAiToolAttributesExtractor.create(ToolCallAttributesGetter.INSTANCE))
            .addAttributesExtractor(new ArmsCommonAttributeExtractor(ArmsRpcTypeEnum.LOCAL_CALL.getCode(),
                ArmsServiceTypeFactory.LLM_INTERNAL.getCode()))
            .addOperationListener(ArmsGenAiAppTypeOnceOperationListener.create())
            .addOperationMetrics(ArmsGenAiMetrics.get())
