...
import static io.opentelemetry.javaagent.instrumentation.spring.ai.alibaba.v1_0.SpringAiAlibabaSingletons.TELEMETRY;
...
public class DashScopeApiInstrumentation implements TypeInstrumentation {

  @Override
  public ElementMatcher<ClassLoader> classLoaderOptimization() {
    return hasClassesNamed("com.alibaba.cloud.ai.dashscope.api.DashScopeApi");
  }

  @Override
  public ElementMatcher<TypeDescription> typeMatcher() {
    return named("com.alibaba.cloud.ai.dashscope.api.DashScopeApi");
  }
